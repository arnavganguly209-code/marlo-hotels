 ...
 *
 * Full-viewport media sits behind the frosted glass header. The booking bar
 * stays fully visible at the bottom without scrolling.
 */
export function Hero({
  ...
  return (
    <section
      ...
      className="relative flex h-dvh flex-col overflow-hidden bg-forest-950"
    >
