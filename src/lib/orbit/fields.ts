...
export const orbitFields: Record<string, OrbitField[]> = {
  ...
  rooms: [
    ...
    { key: "mealPlan", label: "Meal plan", type: "select", options: ["EP", "CP", "MAP", "AP"] },
    { key: "inventory", label: "Available rooms (inventory)", type: "number", required: true },
    { key: "available", label: "Bookable", type: "toggle" },
    ...
    { key: "policies", label: "Features / policies", type: "textarea" },
    ...mediaFields,
    ...seoFields,
  ],
  dining: [
